(function(window) {
    ...
    function Modiran() {
        ...
        const toggleSidebarSwitch = document.querySelector(".toggle-sidebar-switch");
        const creativeSidebarSwitch = document.querySelector(".creative-sidebar-switch");
        const fixHeaderSwitch = document.querySelector(".fix-header-switch");
        const switcheryElems = Array.prototype.slice.call(document.querySelectorAll(".js-switch"));
        ...
        this.handleSwitchery = function(){
            if (typeof Switchery != "undefined"){
                switcheryElems.forEach(function(tag) {
                    new Switchery(tag, {size: "small"});
                });
